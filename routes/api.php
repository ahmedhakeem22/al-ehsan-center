...
Route::prefix('v1')->group(function () {
  ...
  // Biometric Device API (Machine to Machine)
  // Should ideally be protected by a dedicated API Key middleware
  Route::post('/attendance/biometric/push', [App\Http\Controllers\API\BiometricDeviceController::class, 'store']);
});
