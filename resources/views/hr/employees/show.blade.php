                ...
                <div class="row">
                  ...
                  <div class="col-md-7">
                    <ul class="personal-info">
                      <li>
                        <div class="title">رقم البصمة:</div>
                        <div class="text">{{ $employee->biometric_id ?? 'غير محدد' }}</div>
                      </li>
                      <li>
          ...
          <div class="col-md-6 d-flex">
            <div class="card profile-box flex-fill">
              <div class="card-body">
                ...
                <ul class="personal-info">
                  <li>
                    <div class="title">المؤهل العلمي</div>
                    <div class="text">{{ $employee->qualification ?? '-' }}</div>
                  </li>
                  <li>
                  ...
                  @if($employee->user)
                  <li>
                    <div class="title">حساب المستخدم</div>
                    <div class="text">{{ $employee->user->name }}</div>
                  </li>
                  <li>
                    <div class="title">دور المستخدم</div>
                    <div class="text">{{ $employee->user->role->name }}</div>
                  </li>
                  <li>
                    <div class="title">حالة الحساب</div>
                    <div class="text">{{ $employee->user->is_active ? 'نشط' : 'غير نشط' }}</div>
                  </li>
                  @endif
                </ul>
              </div>
            ...
            <div class="table-responsive">
              <table class="table table-striped custom-table">
                ...
                <tbody>
                  ...
                  @empty
                  <tr>
                    <td colspan="4" class="text-center">لا توجد مستندات مرفقة.</td>
                  </tr>
                  @endforelse
                </tbody>
              </table>
