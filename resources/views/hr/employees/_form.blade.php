...
<div class="row">
  ...
  <div class="col-lg-6">
    <div class="card">
      <div class="card-header">
        <h5 class="card-title">المعلومات الشخصية والوظيفية</h5>
      </div>
      <div class="card-body">

        <div class="form-group mb-3">
          <label for="biometric_id" class="form-label">رقم البصمة (في الجهاز)</label>
          <input type="text" class="form-control @error('biometric_id') is-invalid @enderror" id="biometric_id" name="biometric_id" value="{{ old('biometric_id', $employee->biometric_id ?? '') }}">
          <small class="text-muted">الرقم التعريفي للموظف كما يظهر في جهاز البصمة.</small>
  ...
  <div class="col-lg-6">
    <div class="card">
      <div class="card-header">
        <h5 class="card-title">إدارة حساب المستخدم</h5>
      </div>
      <div class="card-body">
