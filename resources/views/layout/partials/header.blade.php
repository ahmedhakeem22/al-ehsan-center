    ...
    <li class="nav-item dropdown has-arrow user-profile-list">
      <a href="javascript:;" class="dropdown-toggle nav-link user-link" data-bs-toggle="dropdown">
        <div class="user-names">
          ...
          <span>{{ Auth::user()->role->name ?? 'Employee' }}</span>
      ...
      <div class="dropdown-menu">
        ...
        <form method="POST" action="{{ route('logout') }}" id="logout-form-1">
          @csrf
          <a class="dropdown-item" href="javascript:void(0);" onclick="document.getElementById('logout-form-1').submit();">Logout</a>
        </form>
      </div>
    </li>
    <li class="nav-item ">
  ...
  <div class="dropdown mobile-user-menu float-end">
    ...
    <div class="dropdown-menu dropdown-menu-end">
      ...
      <form method="POST" action="{{ route('logout') }}" id="logout-form-2">
        @csrf
        <a class="dropdown-item" href="javascript:void(0);" onclick="document.getElementById('logout-form-2').submit();">Logout</a>
      </form>
    </div>
  </div>
</div>